  ...
  return (
    <div className="px-4 max-lg:max-w-3xl mx-auto lg:px-10 grid grid-cols-1 lg:grid-cols-[10fr_12fr] gap-x-8 gap-y-10 w-full mt-20 lg:place-items-center">
        <div className={`${reverse?"lg:order-2":""} max-lg:order-2`}>
            <p className="text-slate-900 font-[iranyekan300] text-4xl lg:text-5xl max-w-xl">
                {title}
            </p>
            ...
            <button className="bg-black/95 max-md:mx-auto block max-w-sm transition-transform active:scale-95 text-base font-[iranyekan300] text-white py-3 px-4 w-full rounded mt-7">
                {button_text}
            </button> */}
        </div>
